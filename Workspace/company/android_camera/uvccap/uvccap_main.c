...
LOGE("in main function 8.\n");
printf("%s: ARGC = %d\n", __func__, argc);
	int opt;
	if ((argc < 2) || ((argc == 2) && ((0 == strcmp(argv[1], "--help")) || (0 == strcmp(argv[1], "-?"))))) {
		usage();
LOGE("in main function 9.\n");
		return 0;
	}
LOGE("in main function 10.\n");
